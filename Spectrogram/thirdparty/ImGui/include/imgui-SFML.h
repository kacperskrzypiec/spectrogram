...
IMGUI_SFML_API bool ImageButton(const char* id, const sf::Texture& texture, const int framePadding = -1,
...
IMGUI_SFML_API bool ImageButton(const char* id, const sf::RenderTexture& texture, const int framePadding = -1,
                                const sf::Color& bgColor = sf::Color::Transparent,
                                const sf::Color& tintColor = sf::Color::White);
...
IMGUI_SFML_API bool ImageButton(const char* id, const sf::Sprite& sprite, const int framePadding = -1,
                                const sf::Color& bgColor = sf::Color::Transparent,
                                const sf::Color& tintColor = sf::Color::White);
